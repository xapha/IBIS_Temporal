...
void Figure::Show(string path, int record)
{
        Initialize();
...
void PlotManager::Plot(const string figure_name, const float *p, int count, int step, int R, int G, int B)
{
        if (count < 1)
                return;
        ...
        active_figure->Show(path, record);
        record = 0;
}
...
// static method
template<typename T>
void plot(const string figure_name, const T* p, int count, int record, const string path, int step, int R, int G, int B)
{
        if (step <= 0)
                step = 1;
...
template
void plot(const string figure_name, const double* p, int count, int record, const string path, int step, int R, int G, int B);

template
void plot(const string figure_name, const float* p, int count, int record, const string path, int step, int R, int G, int B);

template
void plot(const string figure_name, const unsigned char* p, int count, int record, const string path, int step, int R, int G, int B);

template
void plot(const string figure_name, const int* p, int count, int record, const string path, int step, int R, int G, int B);

template
void plot(const string figure_name, const short* p, int count, int record, const string path, int step, int R, int G, int B);
};
